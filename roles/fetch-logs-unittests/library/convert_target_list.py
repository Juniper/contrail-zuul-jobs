...
options:
  ...
  target_file:
    description:
      - "Path to script output - converted UT list. (Default: create unittest_targets.txt in home dir,
         if exist override it)"
    required: false
  strip_prefix:
    description:
      - "Prefix to be striped from paths in UT traget file."
    required: false
'''
...
- name: generate target list
  convert_target_list:
    ...
    target_file: '/home/zuul/unittest_targets.txt'
