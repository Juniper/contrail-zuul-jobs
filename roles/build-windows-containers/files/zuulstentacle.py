...
class RepositoryProvider:
    def __init__(self, archive_base_name, http_server_ip, http_server_port,floating_ip,direcotory):
    ...
    def start_server_with_repositories(self):
        ...
        print("Directory to archive {}") .format(self.direcotory)
