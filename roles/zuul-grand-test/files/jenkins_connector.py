...
class RepositoryProvider:
    def __init__(self, archive_base_name, http_server_ip, http_server_port):
...
class ConfigurationManager:
    ...
    def setup_argument_parser(self):
        self.argument_parser.add_argument(
            ...
            default="http://10.84.12.26:8080",
            help="IP address of Jenkins server")
        self.argument_parser.add_argument(
            "--jenkins_job",
            dest="jenkins_job",
            default="WinContrail/WinCI-ji-test",
...
def CreateZuulsTentacle(configuration):
...
def ReachJenkinsByZuulsTentacle(configuration):
    zuuls_tentacle = CreateZuulsTentacle(configuration)
